"""Training pipeline for Zawaj models.

Trains the partner compatibility model (XGBoost) from a synthetic dataset.
No GNN / family graph — Zawaj uses the In-Laws Questionnaire triangle
analysis for family-level scoring instead.
"""
